...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " pour fermer.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ pour ~g~activer~s~ la radio.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ pour changer de frequence~n~~" .. radioConfig.Controls.Input.Name .. "~ pour choisir une frequence~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ pour ~a~ les Clicks~n~Frequence: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " pour fermer.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ pour ~r~désactiver~s~ la radio.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ pour parler.~n~Frequence: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Entrer une Frequence" },
}
...
Radio.Commands = {
	{
		...
		Help = "Afficher la Radio", -- Command help shown in chatbox when typing the command
		Params = {},
	...
	},
	{
		...
		Help = "Changer de frequence", -- Command help shown in chatbox when typing the command
		Params = {
			{name = "number", "Entrer une frequence"}
		},
		Handler = function(src, args, raw)
			if Radio.Has then
				if args[1] then
