...
Config.Companies.Services = {
    {
        job = "police",
        name = "Police",
        icon = "https://i.imgur.com/Je6tf9H.png",
...
Config.EnableMessagePay = false -- Allow players to pay other players via messages?
...
Config.UploadMethod.Video = "LBUpload" -- "Fivemanage" or "LBUpload" or "Custom"
Config.UploadMethod.Image = "LBUpload" -- "Fivemanage" or "LBUpload" or "Custom
Config.UploadMethod.Audio = "LBUpload" -- "Fivemanage" or "LBUpload" or "Custom"
