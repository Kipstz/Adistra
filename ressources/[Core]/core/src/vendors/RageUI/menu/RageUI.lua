            ...
            if RageUI.CurrentMenu ~= nil then
                if RageUI.CurrentMenu() then
                    ...
                    RageUI.ItemsSafeZone(RageUI.CurrentMenu)
                        ...
                        RenderSprite("RageUI", "interaction_bgd", RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + RageUI.CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, nil)
