GouvernementJob.VestiaireMenu = RageUI.CreateMenu("Gouvernement", "~p~Gouvernement~s~: Vestiaire", 8, 200)

local open = false

GouvernementJob.VestiaireMenu.Closed = function()
    open = false
end

GouvernementJob.OpenVestiaireMenu = function()
    if open then
        RageUI.CloseAll()
        RageUI.Visible(GouvernementJob.VestiaireMenu, false)
        open = false
    else
        RageUI.CloseAll()
        RageUI.Visible(GouvernementJob.VestiaireMenu, true)
        open = true
        ...
        CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(GouvernementJob.VestiaireMenu, true, true, true, function()
                    ...
                    for k,v in pairs(Config['job_gouvernement'].Tenues) do
                    ...
                    for k,v in pairs(Config['job_gouvernement'].GPB) do
                    ...
                    for k,v in pairs(Config['job_gouvernement'].Sacs) do
