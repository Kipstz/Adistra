...
UnicornJob.inHarvest = false
UnicornJob.inCraft = false
...
CreateThread(function()
    while true do
        ...
        if Framework.PlayerData.jobs and Framework.PlayerData.jobs['job'].name == 'unicorn' then
            for k,v in pairs(Config['job_unicorn'].Points) do
                if k ~= 'deleters' then
