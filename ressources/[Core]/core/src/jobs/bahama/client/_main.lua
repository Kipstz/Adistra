...
BahamaJob.inHarvest = false
BahamaJob.inCraft = false
...
CreateThread(function()
    while true do
        ...
        if Framework.PlayerData.jobs and Framework.PlayerData.jobs['job'].name == 'bahama' then
            for k,v in pairs(Config['job_bahama'].Points) do
                if k ~= 'deleters' then
