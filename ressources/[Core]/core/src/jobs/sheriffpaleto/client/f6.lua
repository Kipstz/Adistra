...
SheriffPaletoJob.F6Menu = RageUI.CreateMenu("Sheriff", "~p~Sheriff~s~: Actions", 8, 200)

SheriffPaletoJob.InteractionsCitoyens = RageUI.CreateSubMenu(SheriffPaletoJob.F6Menu, "Sheriff", "~p~Sheriff~s~: Interactions Citoyens", 8, 200)
SheriffPaletoJob.FacturesMenu = RageUI.CreateSubMenu(SheriffPaletoJob.InteractionsCitoyens, "Sheriff", "~p~Sheriff~s~: Factures", 8, 200)
SheriffPaletoJob.FouilleMenu = RageUI.CreateSubMenu(SheriffPaletoJob.InteractionsCitoyens, "Sheriff", "~p~Sheriff~s~: Fouille", 8, 200)

SheriffPaletoJob.InteractionsVehicules = RageUI.CreateSubMenu(SheriffPaletoJob.F6Menu, "Sheriff", "~p~Sheriff~s~: Interactions Vehicules", 8, 200)
SheriffPaletoJob.VehicleInfosMenu = RageUI.CreateSubMenu(SheriffPaletoJob.InteractionsVehicules, "Sheriff", "~p~Sheriff~s~: Informations du Véhicule", 8, 200)

SheriffPaletoJob.GestionsObjets = RageUI.CreateSubMenu(SheriffPaletoJob.F6Menu, "Sheriff", "~p~Sheriff~s~: Gestion Objets", 8, 200)

SheriffPaletoJob.AutresMenu = RageUI.CreateSubMenu(SheriffPaletoJob.F6Menu, "Sheriff", "~p~Sheriff~s~: Autres", 8, 200)
...
SheriffPaletoJob.F6Menu.Closed = function()
    open = false
end

SheriffPaletoJob.ServiceCheck = false

SheriffPaletoJob.OpenF6Menu = function()
    if open then
        RageUI.CloseAll()
        RageUI.Visible(SheriffPaletoJob.F6Menu, false)
        open = false
    else
        RageUI.CloseAll()
        RageUI.Visible(SheriffPaletoJob.F6Menu, true)
        open = true
        ...
        CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(SheriffPaletoJob.F6Menu, true, true, true, function()
                    RageUI.Checkbox("Prise de Service", nil, SheriffPaletoJob.ServiceCheck, {}, function(Hovered, Active, Selected, Checked)
                        if Selected then
                            SheriffPaletoJob.ServiceCheck = Checked
                            ...
                            if Checked then        
                                Framework.TriggerServerCallback("service:enableService", function(canTakeService, maxInService, inServiceCount)
                                    if canTakeService then
                                        ...
                                        TriggerServerEvent("service:notifyAllInService", notification, 'sheriffpaleto')
                                    else
                                ...
                                TriggerServerEvent("service:notifyAllInService", notification, 'sheriffpaleto')
                                TriggerServerEvent("service:disableService", 'sheriffpaleto')
                            end
                        end
                    end)

                    if SheriffPaletoJob.ServiceCheck then
                        ...
                        end, SheriffPaletoJob.InteractionsCitoyens)
                        ...
                        end, SheriffPaletoJob.InteractionsVehicules)
    
                        RageUI.ButtonWithStyle("Gestions Objets", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                        end, SheriffPaletoJob.GestionsObjets)
    
                        RageUI.ButtonWithStyle("Autres", nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                        end, SheriffPaletoJob.AutresMenu)
                    end

                end)

                RageUI.IsVisible(SheriffPaletoJob.InteractionsCitoyens, true, true, true, function()
                    local myCoords = GetEntityCoords(PlayerPedId())
                    local closestPlayer, closestPlayerDistance = Framework.Game.GetClosestPlayer(myCoords)
                    ...
                    end, SheriffPaletoJob.FacturesMenu)

                    RageUI.Separator("↓   Actions   ↓")

                    RageUI.ButtonWithStyle("Menotter", nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            exports["ac"]:ExecuteServerEvent("SheriffPaletoJob:Menotter", GetPlayerServerId(closestPlayer))
                        end
                    end)

                    RageUI.ButtonWithStyle("Escorter", nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            exports["ac"]:ExecuteServerEvent("SheriffPaletoJob:Escorter", GetPlayerServerId(closestPlayer))
                        end
                    end)

                    RageUI.ButtonWithStyle("Mettre/Sortir du Véhicule", nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            exports["ac"]:ExecuteServerEvent("SheriffPaletoJob:MettreSortirVeh", GetPlayerServerId(closestPlayer))
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Fouiller", "~r~La personne doit avoir les mains levées !", { RightLabel = "→" }, handsUp, function(Hovered, Active, Selected)
                        if Selected then
                            Framework.TriggerServerCallback("SheriffPaletoJob:getPlayerData", function(data) 
                                playerData = data
                            end, GetPlayerServerId(closestPlayer))
                        end
                    end, SheriffPaletoJob.FouilleMenu)
                    ...
                    RageUI.ButtonWithStyle("Mettre une amende", nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            if tostring(raison) and tonumber(amount) then
                                exports["ac"]:ExecuteServerEvent('billing:sendBill', GetPlayerServerId(closestPlayer), 'sheriffpaleto', raison, amount)
                            else
                ...
                RageUI.IsVisible(SheriffPaletoJob.FacturesMenu, true, true, true, function()
                ...
                RageUI.IsVisible(SheriffPaletoJob.FouilleMenu, true, true, true, function()
                            ...
                            RageUI.ButtonWithStyle(v.itemLabel, "~r~ENTER ~s~pour confisquer", { RightLabel = "~b~x"..v.itemCount }, true, function(Hovered, Active, Selected)
                                if Selected then
                                    ...
                                    if tonumber(quantite) and v.itemCount >= tonumber(quantite) then
                                        ...
                                        exports["ac"]:ExecuteServerEvent("SheriffPaletoJob:Confiscate", playerData.src, 'item', { name = v.itemName, label = v.itemLabel, ammo = v.itemCount}, tonumber(quantite))
                                    else
                            ...
                            RageUI.ButtonWithStyle(v.weaponLabel, "~r~ENTER ~s~pour confisquer", { RightLabel = "~o~"..v.weaponAmmo.."Mun" }, true, function(Hovered, Active, Selected)
                                if Selected then
                                    if not Framework.WeaponisBoutique(v.weaponName) then
                                        exports["ac"]:ExecuteServerEvent("SheriffPaletoJob:Confiscate", playerData.src, 'weapon', { name = v.weaponName, label = v.weaponLabel, ammo = v.weaponAmmo})
                ...
                RageUI.IsVisible(SheriffPaletoJob.InteractionsVehicules, true, true, true, function()
                    ...
                    if closestVeh ~= -1 and closestVehDistance < 5 then
                        ...
                        RageUI.ButtonWithStyle("Informations du Véhicule", nil, {}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                Framework.TriggerServerCallback("SheriffPaletoJob:getVehicleInfos", function(info)
                                    retrivedInfo = info
                                end, vehicleProps.plate)
                            end
                        end, SheriffPaletoJob.VehicleInfosMenu)
                ...
                RageUI.IsVisible(SheriffPaletoJob.VehicleInfosMenu, true, true, true, function()
                ...
                RageUI.IsVisible(SheriffPaletoJob.GestionsObjets, true, true, true, function()
                ...
                RageUI.IsVisible(SheriffPaletoJob.AutresMenu, true, true, true, function()

                    RageUI.ButtonWithStyle("Activer/Désactiver le Bouclier", nil, {}, true, function(Hovered, Active, Selected)
                        if Selected then
                            SheriffPaletoJob.ActiveBouclier()
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Code 1", nil, {}, canUseRenfort, function(Hovered, Active, Selected)
                        if Selected then
                            canUseRenfort = false
                            TriggerServerEvent("SheriffPaletoJob:Renfort", 'legere', GetEntityCoords(PlayerPedId()))
                            canReuseRenfort()
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Code 2", nil, {}, canUseRenfort, function(Hovered, Active, Selected)
                        if Selected then
                            canUseRenfort = false
                            TriggerServerEvent("SheriffPaletoJob:Renfort", 'importante', GetEntityCoords(PlayerPedId()))
                            canReuseRenfort()
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Code 3", nil, {}, canUseRenfort, function(Hovered, Active, Selected)
                        if Selected then
                            canUseRenfort = false
                            TriggerServerEvent("SheriffPaletoJob:Renfort", 'urgente', GetEntityCoords(PlayerPedId()))
                            canReuseRenfort()
                        end
                    end)
...
SheriffPaletoJob.ActiveBouclier = function()
...
RegisterNetEvent("SheriffPaletoJob:Menotter")
AddEventHandler("SheriffPaletoJob:Menotter", function()
...
RegisterNetEvent("SheriffPaletoJob:Escorter")
AddEventHandler("SheriffPaletoJob:Escorter", function(copId)
    local playerPed
	local targetPed
...
RegisterNetEvent("SheriffPaletoJob:MettreSortirVeh")
AddEventHandler("SheriffPaletoJob:MettreSortirVeh", function()
    local PlayerPed = PlayerPedId()
...
RegisterNetEvent("SheriffPaletoJob:setBlip")
AddEventHandler("SheriffPaletoJob:setBlip", function(coords, raison)
	if raison == 'legere' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		PlaySoundFrontend(-1, "OOB_Start", "GTAO_FM_Events_Soundset", 1)

		Framework.ShowAdvancedNotification('Sheriff', '~b~Demande de renfort', 'Demande de renfort demandé.\nRéponse: ~g~CODE-2\n~w~Importance: ~g~Légère.', 'CHAR_CALL911')
		Wait(1000)
	...
	AddTextComponentString("~r~Sheriff ~s~| Demande renfort")
