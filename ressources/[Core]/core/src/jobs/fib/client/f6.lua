...
FibJob.F6Menu = RageUI.CreateMenu("FIB", "~p~FIB~s~: Actions", 8, 200)

FibJob.InteractionsCitoyens = RageUI.CreateSubMenu(FibJob.F6Menu, "FIB", "~p~FIB~s~: Interactions Citoyens", 8, 200)
FibJob.FacturesMenu = RageUI.CreateSubMenu(FibJob.InteractionsCitoyens, "FIB", "~p~FIB~s~: Factures", 8, 200)
FibJob.FouilleMenu = RageUI.CreateSubMenu(FibJob.InteractionsCitoyens, "FIB", "~p~FIB~s~: Fouille", 8, 200)

FibJob.InteractionsVehicules = RageUI.CreateSubMenu(FibJob.F6Menu, "FIB", "~p~FIB~s~: Interactions Vehicules", 8, 200)
FibJob.VehicleInfosMenu = RageUI.CreateSubMenu(FibJob.InteractionsVehicules, "FIB", "~p~FIB~s~: Informations du Véhicule", 8, 200)

FibJob.GestionsObjets = RageUI.CreateSubMenu(FibJob.F6Menu, "FIB", "~p~FIB~s~: Gestion Objets", 8, 200)

FibJob.AutresMenu = RageUI.CreateSubMenu(FibJob.F6Menu, "FIB", "~p~FIB~s~: Autres", 8, 200)
...
FibJob.F6Menu.Closed = function()
    open = false
end

FibJob.ServiceCheck = false

FibJob.OpenF6Menu = function()
    if open then
        RageUI.CloseAll()
        RageUI.Visible(FibJob.F6Menu, false)
        open = false
    else
        RageUI.CloseAll()
        RageUI.Visible(FibJob.F6Menu, true)
        open = true
        ...
        CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(FibJob.F6Menu, true, true, true, function()
                    RageUI.Checkbox("Prise de Service", nil, FibJob.ServiceCheck, {}, function(Hovered, Active, Selected, Checked)
                        if Selected then
                            FibJob.ServiceCheck = Checked
                            ...
                            if Checked then        
                                Framework.TriggerServerCallback("service:enableService", function(canTakeService, maxInService, inServiceCount)
                                    if canTakeService then
                                        ...
                                        TriggerServerEvent("service:notifyAllInService", notification, 'fib')
                                    else
                                ...
                                TriggerServerEvent("service:disableService", 'fib')
                            end
                        end
                    end)

                    if FibJob.ServiceCheck then
                        ...
                        end, FibJob.InteractionsCitoyens)
                ...
                RageUI.IsVisible(FibJob.InteractionsCitoyens, true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Fouiller", "~r~La personne doit avoir les mains levées !", { RightLabel = "→" }, handsUp, function(Hovered, Active, Selected)
                        if Selected then
                            Framework.TriggerServerCallback("FibJob:getPlayerData", function(data) 
                                playerData = data
                            end, GetPlayerServerId(closestPlayer))
                        end
                    end, FibJob.FouilleMenu)
                    ...
                    RageUI.ButtonWithStyle("Mettre une amende", nil, { RightLabel = "→" }, true, function(Hovered, Active, Selected)
                        if Selected then
                            ...
                            if tostring(raison) and tonumber(amount) then
                                exports["ac"]:ExecuteServerEvent('billing:sendBill', GetPlayerServerId(closestPlayer), 'fib', raison, amount)
                            else
                ...
                RageUI.IsVisible(FibJob.FacturesMenu, true, true, true, function()
                ...
                RageUI.IsVisible(FibJob.FouilleMenu, true, true, true, function()
                            ...
                            RageUI.ButtonWithStyle(v.itemLabel, "~r~ENTER ~s~pour confisquer", { RightLabel = "~b~x"..v.itemCount }, true, function(Hovered, Active, Selected)
                                if Selected then
                                    ...
                                    if tonumber(quantite) and v.itemCount >= tonumber(quantite) then
                                        ...
                                        exports["ac"]:ExecuteServerEvent("FibJob:Confiscate", playerData.src, 'item', { name = v.itemName, label = v.itemLabel, ammo = v.itemCount}, tonumber(quantite))
                                    else
                            ...
                            RageUI.ButtonWithStyle(v.weaponLabel, "~r~ENTER ~s~pour confisquer", { RightLabel = "~o~"..v.weaponAmmo.."Mun" }, true, function(Hovered, Active, Selected)
                                if Selected then
                                    if not Framework.WeaponisBoutique(v.weaponName) then
                                        exports["ac"]:ExecuteServerEvent("FibJob:Confiscate", playerData.src, 'weapon', { name = v.weaponName, label = v.weaponLabel, ammo = v.weaponAmmo})
                ...
                RageUI.IsVisible(FibJob.InteractionsVehicules, true, true, true, function()
                    ...
                    if closestVeh ~= -1 and closestVehDistance < 5 then
                        ...
                        RageUI.ButtonWithStyle("Informations du Véhicule", nil, {}, true, function(Hovered, Active, Selected)
                            if Selected then
                                ...
                                Framework.TriggerServerCallback("FibJob:getVehicleInfos", function(info)
                                    retrivedInfo = info
                                end, vehicleProps.plate)
                            end
                        end, FibJob.VehicleInfosMenu)
                ...
                RageUI.IsVisible(FibJob.VehicleInfosMenu, true, true, true, function()
                ...
                RageUI.IsVisible(FibJob.GestionsObjets, true, true, true, function()
                ...
                RageUI.IsVisible(FibJob.AutresMenu, true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Code 1", nil, {}, canUseRenfort, function(Hovered, Active, Selected)
                        if Selected then
                            canUseRenfort = false
                            TriggerServerEvent("FibJob:Renfort", 'legere', GetEntityCoords(PlayerPedId()))
                            canReuseRenfort()
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Code 2", nil, {}, canUseRenfort, function(Hovered, Active, Selected)
                        if Selected then
                            canUseRenfort = false
                            TriggerServerEvent("FibJob:Renfort", 'importante', GetEntityCoords(PlayerPedId()))
                            canReuseRenfort()
                        end
                    end)
                    ...
                    RageUI.ButtonWithStyle("Code 3", nil, {}, canUseRenfort, function(Hovered, Active, Selected)
                        if Selected then
                            canUseRenfort = false
                            TriggerServerEvent("FibJob:Renfort", 'urgente', GetEntityCoords(PlayerPedId()))
                            canReuseRenfort()
                        end
                    end)
                end)
...
FibJob.ActiveBouclier = function()
...
RegisterNetEvent("FibJob:Menotter")
AddEventHandler("FibJob:Menotter", function()
...
RegisterNetEvent("FibJob:Escorter")
AddEventHandler("FibJob:Escorter", function(copId)
    local plyPed
	local targetPed
...
RegisterNetEvent("FibJob:MettreSortirVeh")
AddEventHandler("FibJob:MettreSortirVeh", function()
    local PlayerPed = PlayerPedId()
...
RegisterNetEvent("FibJob:setBlip")
AddEventHandler("FibJob:setBlip", function(coords, raison)
	if raison == 'legere' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		PlaySoundFrontend(-1, "OOB_Start", "GTAO_FM_Events_Soundset", 1)

		Framework.ShowAdvancedNotification('FIB', '~b~Demande de renfort', 'Demande de renfort demandé.\nRéponse: ~g~CODE-2\n~w~Importance: ~g~Légère.', 'CHAR_CALL911')
		Wait(1000)
	...
	AddTextComponentString("~r~FIB ~s~| Demande renfort")
