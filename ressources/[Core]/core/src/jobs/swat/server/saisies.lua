...
Framework.RegisterServerCallback("SwatJob:getSaisiePlayerData", function(src, cb, player)
    local src = src;
...
RegisterNetEvent('SwatJob:addSaisie')
AddEventHandler('SwatJob:addSaisie', function(saisie)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
    local can = false;
...
Framework.RegisterServerCallback("SwatJob:getAllSaisies", function(src, cb, player)
    local src = src;
    local xPlayer = Framework.GetPlayerFromId(src)
...
RegisterNetEvent('SwatJob:editSaisie')
AddEventHandler('SwatJob:editSaisie', function(saisie, playerData, playerData2)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
...
RegisterNetEvent('SwatJob:removeSaisie')
AddEventHandler('SwatJob:removeSaisie', function(saisie)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
    local found = false;
...
RegisterNetEvent('SwatJob:giveSaisie')
AddEventHandler('SwatJob:giveSaisie', function(saisie)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
