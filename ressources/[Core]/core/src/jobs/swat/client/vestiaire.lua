SwatJob.VestiaireMenu = RageUI.CreateMenu("SWAT", "~p~SWAT~s~: Vestiaire", 8, 200)

local open = false

SwatJob.VestiaireMenu.Closed = function()
    open = false
end

SwatJob.OpenVestiaireMenu = function()
    if open then
        RageUI.CloseAll()
        RageUI.Visible(SwatJob.VestiaireMenu, false)
        open = false
    else
        RageUI.CloseAll()
        RageUI.Visible(SwatJob.VestiaireMenu, true)
        open = true
        ...
        CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(SwatJob.VestiaireMenu, true, true, true, function()
                    ...
                    for k,v in pairs(Config['job_swat'].Tenues) do
                    ...
                    for k,v in pairs(Config['job_swat'].GPB) do
                    ...
                    for k,v in pairs(Config['job_swat'].Sacs) do
