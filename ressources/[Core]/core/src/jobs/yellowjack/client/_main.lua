...
YellowJackJob.inHarvest = false
YellowJackJob.inCraft = false
...
CreateThread(function()
    while true do
        ...
        if Framework.PlayerData.jobs and Framework.PlayerData.jobs['job'].name == 'yellowjack' then
            for k,v in pairs(Config['job_yellowjack'].Points) do
                if k ~= 'deleters' then
