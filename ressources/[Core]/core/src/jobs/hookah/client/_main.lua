...
HookahJob.inHarvest = false
HookahJob.inCraft = false
...
CreateThread(function()
    while true do
        ...
        if Framework.PlayerData.jobs and Framework.PlayerData.jobs['job'].name == 'hookah' then
            for k,v in pairs(Config['job_hookah'].Points) do
                if k ~= 'deleters' then
