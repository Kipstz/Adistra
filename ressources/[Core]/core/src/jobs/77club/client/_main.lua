...
NightClub.inHarvest = false
NightClub.inCraft = false
...
CreateThread(function()
    while true do
        ...
        if Framework.PlayerData.jobs and Framework.PlayerData.jobs['job'].name == '77club' then
            for k,v in pairs(Config['job_77club'].Points) do
                if k ~= 'deleters' then
