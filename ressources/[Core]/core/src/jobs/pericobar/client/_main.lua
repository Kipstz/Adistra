...
PericoBarJob.inHarvest = false
PericoBarJob.inCraft = false
...
CreateThread(function()
    while true do
        ...
        if Framework.PlayerData.jobs and Framework.PlayerData.jobs['job'].name == 'pericobar' then
            for k,v in pairs(Config['job_pericobar'].Points) do
                if k ~= 'deleters' then
