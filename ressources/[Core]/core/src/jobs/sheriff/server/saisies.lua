...
Framework.RegisterServerCallback("SheriffJob:getSaisiePlayerData", function(src, cb, player)
    local src = src;
...
RegisterNetEvent('SheriffJob:addSaisie')
AddEventHandler('SheriffJob:addSaisie', function(saisie)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
    local can = false;
...
Framework.RegisterServerCallback("SheriffJob:getAllSaisies", function(src, cb, player)
    local src = src;
    local xPlayer = Framework.GetPlayerFromId(src)
...
RegisterNetEvent('SheriffJob:editSaisie')
AddEventHandler('SheriffJob:editSaisie', function(saisie, playerData, playerData2)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
...
RegisterNetEvent('SheriffJob:removeSaisie')
AddEventHandler('SheriffJob:removeSaisie', function(saisie)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
    local found = false;
...
RegisterNetEvent('SheriffJob:giveSaisie')
AddEventHandler('SheriffJob:giveSaisie', function(saisie)
    local src = source;
    local xPlayer = Framework.GetPlayerFromId(src)
