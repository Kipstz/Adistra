SheriffJob.VestiaireMenu = RageUI.CreateMenu("Sheriff", "~p~Sheriff~s~: Vestiaire", 8, 200)

local open = false

SheriffJob.VestiaireMenu.Closed = function()
    open = false
end

SheriffJob.OpenVestiaireMenu = function()
    if open then
        RageUI.CloseAll()
        RageUI.Visible(SheriffJob.VestiaireMenu, false)
        open = false
    else
        RageUI.CloseAll()
        RageUI.Visible(SheriffJob.VestiaireMenu, true)
        open = true
        ...
        CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(SheriffJob.VestiaireMenu, true, true, true, function()
                    ...
                    for k,v in pairs(Config['job_sheriff'].Tenues) do
                    ...
                    for k,v in pairs(Config['job_sheriff'].GPB) do
                    ...
                    for k,v in pairs(Config['job_sheriff'].Sacs) do
