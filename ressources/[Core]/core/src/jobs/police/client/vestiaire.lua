PoliceJob.VestiaireMenu = RageUI.CreateMenu("LSPD", "~p~LSPD~s~: Vestiaire", 8, 200)

local open = false

PoliceJob.VestiaireMenu.Closed = function()
    open = false
end

PoliceJob.OpenVestiaireMenu = function()
    if open then
        RageUI.CloseAll()
        RageUI.Visible(PoliceJob.VestiaireMenu, false)
        open = false
    else
        RageUI.CloseAll()
        RageUI.Visible(PoliceJob.VestiaireMenu, true)
        open = true
        ...
        CreateThread(function()
            while open do
                ...
                RageUI.IsVisible(PoliceJob.VestiaireMenu, true, true, true, function()
                    ...
                    for k,v in pairs(Config['job_police'].Tenues) do
                    ...
                    for k,v in pairs(Config['job_police'].GPB) do
                    ...
                    for k,v in pairs(Config['job_police'].Sacs) do
