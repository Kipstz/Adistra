...
Config['job_fib'] = {
        ...
        --Vespucci = {
            ...
            boss = {
                ...
                action = function()
                    ...
                    local wlGrades = {'boss'}
                    TriggerEvent('bossManagement:openMenu', 'fib', wlGrades)
                end
            }
        --}
    },
    ...
    Garage = {
        ...
        Categories = {
            ...
            { minGrade = 5, name = 'spec',    label = "Special" },
        },

        Vehicules = {
            { categorie = 'base', minGrade = 0, model = 'fbi', label = "Véhicule"},
            { categorie = 'base', minGrade = 1, model = 'fbi2', label = "Véhicule 2"},
            { categorie = 'base', minGrade = 1, model = 'buffalosxpol', label = "Buffalo STX"},
            { categorie = 'base', minGrade = 1, model = 'fibbuffalosx', label = "Buffalo STX 2"},

            { categorie = 'spec', minGrade = 1, model = 'riot', label = "Riot 1"},
            { categorie = 'spec', minGrade = 1, model = 'riot2', label = "Riot 2"},        
        }
    },
