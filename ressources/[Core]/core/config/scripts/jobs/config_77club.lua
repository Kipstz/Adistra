Config['job_77club'] = {
    Points = {
        ...
        harvest = {
            ...
            action = function()
                NightClub.OpenHarvestMenu()
            end
        },
        craft = {
            pos = vector3(247.3, -3161.5, -0.2),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Bar",

            action = function()
                NightClub.OpenCraftMenu()
            end
        },
        garage = {
            pos = vector3(204.6, -3131.0, 5.8),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

            action = function()
                NightClub.OpenGarageMenu()
            end
        },
        deleters = {
            pos = {
                vector3(204.2, -3122.5, 5.8),
            },
        ...
        boss = {
            pos = vector3(243.6, -3153.0, 3.3),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Actions Patron",

            action = function()
                TriggerEvent('bossManagement:openMenu', '77club')
            end
        }
    },
    ...
    Garage = {
        SpawnPos = vector3(204.2, -3122.5, 5.8),
        SpawnHeading = 90.0,
