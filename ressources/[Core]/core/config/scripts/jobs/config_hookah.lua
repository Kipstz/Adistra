Config['job_hookah'] = {
    Points = {
        harvest = {
            ...
            action = function()
                HookahJob.OpenHarvestMenu()
            end
        },
        craft = {
            pos = vector3(-443.5, -35.7, 46.2),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Bar",

            action = function()
                HookahJob.OpenCraftMenu()
            end
        },
        garage = {
            pos = vector3(-427.7, -36.7, 46.2),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

            action = function()
                HookahJob.OpenGarageMenu()
            end
        },
        deleters = {
            pos = {
                vector3(-409.8, -37.9, 46.1),
            },
        ...
        boss = {
            pos = vector3(-443.4, -37.2, 40.9),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Actions Patron",

            action = function()
                TriggerEvent('bossManagement:openMenu', 'hookah')
            end
        }
    },
    ...
    Garage = {
        SpawnPos = vector3(-409.8, -37.9, 46.1),
        SpawnHeading = 90.0,
    ...
    itemsHarvest = {
        ...
        { name = 'corpschicha', label = "Corps de chicha", price = 5 },
        { name = 'charbonchicha', label = "Charbon à chicha", price = 5 },
    ...
    itemsCraft = {
        ...
        { needs = {'corpschicha', 'charbonchicha'}, name = 'chicha', label = "Faire une Chicha", desc = "Requis: ~b~Corps de Chicha~s~/~b~Charbon à Chicha~s~" },
