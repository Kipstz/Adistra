...
Config['job_sheriff'] = {
    SheriffStations = {
        -- = {
            vestiaire = {
                pos = vector3(1827.5, 3676.9, 34.7),
                msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Vestiaire",

                action = function()
                    SheriffJob.OpenVestiaireMenu()
                end
            },
            armurerie = {
                pos = vector3(1833.6, 3695.6, 34.7),
                msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder à l'armurerie ",

                action = function()
                    SheriffJob.OpenArmurerieMenu()
                end
            },
            garage = {
                pos = vector3(1842.5, 3672.3, 34.1),
                msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

                action = function()
                    SheriffJob.OpenGarageMenu()
                end
            },
            garage2 = {
                pos = vector3(1831.1, 3674.9, 43.0),
                msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage Helicoptère",

                action = function()
                    SheriffJob.OpenGarage2Menu()
                end
            },
            saisies = {
                ...
                action = function()
                    SheriffJob.OpenSaisiesMenu()
                end
            },
            deleters = {
                pos = {
                    vector3(1852.0, 3682.0, 33.9),
                },
            ...
            boss = {
                pos = vector3(1824.3, 3688.7, 39.1),
                ...
                action = function()
                    ...
                    local wlGrades = {'boss'}
                    TriggerEvent('bossManagement:openMenu', 'sheriff', wlGrades)
                end
            }
        --}
    },
    ...
    Garage = {
        SpawnPos = vector3(1852.0, 3682.0, 33.9),
        SpawnHeading = -130.91,
    ...
    Garage2 = {
        SpawnPos = vector3(1824.5, 3686.3, 43.0),
        SpawnHeading = 95.91,
