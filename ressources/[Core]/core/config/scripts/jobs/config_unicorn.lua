Config['job_unicorn'] = {
    Points = {
        vestiaire = {
            pos = vector3(103.3854, -1301.0269, 29.2189),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Vestiaire",

            action = function()
                UnicornJob.OpenVestiaireMenu()
            end
        },
        harvest = {
            pos = vector3(109.2832, -1284.1661, 29.6187),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Fournisseur",

            action = function()
                UnicornJob.OpenHarvestMenu()
            end
        },
        craft = {
            pos = vector3(116.0157, -1280.4991, 29.6188),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Bar",

            action = function()
                UnicornJob.OpenCraftMenu()
            end
        },
        garage = {
            pos = vector3(94.9006, -1293.0983, 29.2188),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

            action = function()
                UnicornJob.OpenGarageMenu()
            end
        },
        deleters = {
            pos = {
                vector3(91.1238, -1291.4893, 29.2189),
            },
        ...
        boss = {
            pos = vector3(98.0376, -1297.8025, 35.5849),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Actions Patron",

            action = function()
                TriggerEvent('bossManagement:openMenu', 'unicorn')
            end
        }
    },
    ...
    Garage = {
        SpawnPos = vector3(91.1264, -1291.4856, 29.2189),
        SpawnHeading = 30.6,
