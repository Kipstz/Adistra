Config['job_tequilala'] = {
    Points = {
        ...
        --     action = function()
        --         TequilalaJob.OpenVestiaireMenu()
        --     end
        -- },
        harvest = {
            ...
            action = function()
                TequilalaJob.OpenHarvestMenu()
            end
        },
        craft = {
            pos = vector3(-562.1, 286.3, 82.2),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Bar",

            action = function()
                TequilalaJob.OpenCraftMenu()
            end
        },
        garage = {
            pos = vector3(-564.7, 298.2, 83.1),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

            action = function()
                TequilalaJob.OpenGarageMenu()
            end
        },
        deleters = {
            pos = {
                vector3(-560.9, 302.0, 83.1),
            },
        ...
        boss = {
            pos = vector3(-573.4, 291.9, 79.2),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Actions Patron",

            action = function()
                TriggerEvent('bossManagement:openMenu', 'tequilala')
            end
        }
    },
    ...
    Garage = {
        SpawnPos = vector3(-560.9, 302.0, 83.1),
        SpawnHeading = 90.0,
