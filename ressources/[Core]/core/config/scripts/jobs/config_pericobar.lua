Config['job_pericobar'] = {
    Points = {
        -- vestiaire = {
        --     pos = vector3(102.9, -1299.9, 29.2),
        --     msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Vestiaire",

        --     action = function()
        --         PericoBarJob.OpenVestiaireMenu()
        --     end
        -- },
        harvest = {
            pos = vector3(4441.8, -4450.5, 4.3),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Fournisseur",

            action = function()
                PericoBarJob.OpenHarvestMenu()
            end
        },
        craft = {
            pos = vector3(4905.7, -4942.2, 3.4),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Bar",

            action = function()
                PericoBarJob.OpenCraftMenu()
            end
        },
        garage = {
            pos = vector3(4936.3, -4906.5, 3.5),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

            action = function()
                PericoBarJob.OpenGarageMenu()
            end
        },
        deleters = {
            pos = {
                vector3(4927.5, -4900.9, 3.6),
            },
        ...
        boss = {
            pos = vector3(4901.7, -4945.0, 3.4),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Actions Patron",

            action = function()
                TriggerEvent('bossManagement:openMenu', 'pericobar')
            end
        }
    },
    ...
    Garage = {
        SpawnPos = vector3(4927.5, -4900.9, 3.6),
        SpawnHeading = 90.0,
