Config['job_yellowjack'] = {
    Points = {
        -- vestiaire = {
        --     pos = vector3(254.3, -3152.0, -0.2),
        --     msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Vestiaire",

        --     action = function()
        --         YellowJackJob.OpenVestiaireMenu()
        --     end
        -- },
        harvest = {
            ...
            action = function()
                YellowJackJob.OpenHarvestMenu()
            end
        },
        craft = {
            pos = vector3(1982.4, 3052.9, 47.2),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Bar",

            action = function()
                YellowJackJob.OpenCraftMenu()
            end
        },
        garage = {
            pos = vector3(1999.4, 3041.0, 47.0),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Garage",

            action = function()
                YellowJackJob.OpenGarageMenu()
            end
        },
        deleters = {
            pos = {
                vector3(1994.5, 3035.3, 47.0),
            },
        ...
        boss = {
            pos = vector3(1988.2, 3046.7, 50.5),
            msg = "Appuyez sur ~INPUT_CONTEXT~ pour acceder au Actions Patron",

            action = function()
                TriggerEvent('bossManagement:openMenu', 'yellowjack')
            end
        }
    },
    ...
    Garage = {
        SpawnPos = vector3(1994.5, 3035.3, 47.0),
        SpawnHeading = 90.0,
