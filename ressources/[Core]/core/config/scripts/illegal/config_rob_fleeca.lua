...
Config['rob_fleeca'] = {
    ...
    timer = 90, -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
    hacktime = 1000, -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
    maxcash = 2000, -- maximum amount of cash a pile can hold
    mincash = 1000, -- minimum amount of cash a pile holds
    black = true, -- enable this if you want blackmoney as a reward
    cooldown = (60*30), -- amount of time to do the heist again in seconds (15min)
    mincops = 5, -- minimum required cops to start mission
    vaultdoor = "v_ilev_gb_vauldr",
    door = "v_ilev_gb_vaubar",
    office = "v_ilev_gb_teldr",
    Banks = {
        F1 = {
            doors = {
