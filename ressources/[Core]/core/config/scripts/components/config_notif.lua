Config['notif'] = {
    Timeout          = 7500,          -- Overridden by the `timeout` param
    Position         = "bottomleft",
    Progress         = true,          -- Overridden by the `progress` param
    Theme            = "default",     -- Overridden by the `theme` param
    Queue            = 5,             -- No. of notifications to show before queueing
    Stacking         = true,
    ShowStackedCount = true,
    AnimationIn      = "fadeIn",     -- Enter animation - 'fadeOut', 'fadeOutLeft', 'flipOutX', 'flipOutY', 'bounceOutLeft', 'backOutLeft', 'slideOutLeft', 'zoomOut', 'zoomOutLeft'
    AnimationOut     = "fadeOut",    -- Exit animation - 'fadeOut', 'fadeOutLeft', 'flipOutX', 'flipOutY', 'bounceOutLeft', 'backOutLeft', 'slideOutLeft', 'zoomOut', 'zoomOutLeft'
    AnimationTime    = 350,           -- Entry / exit animation interval
    SoundFile        = false,         -- Sound file stored in ui/audio used for notification sound. Leave as false to disable.
