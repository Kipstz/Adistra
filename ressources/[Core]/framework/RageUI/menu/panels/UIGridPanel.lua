local Grid = {
    ...
    Grid = { Dictionary = "pause_menu_pages_char_mom_dad", Texture = "nose_grid", X = 112, Y = 45, Width = 200, Height = 200 },
    Circle = { Dictionary = "mpinventory", Texture = "in_world_circle", X = 115.5, Y = 47.5, Width = 20, Height = 20 },
    Text = {
        Top = { X = 205, Y = 15, Scale = 0.30 },
        Bottom = { X = 205, Y = 250, Scale = 0.30 },
        Left = { X = 46, Y = 130, Scale = 0.30 },
        Right = { X = 375, Y = 130, Scale = 0.30 },
    },
}
